...
sits at the origin, where the lattice file already has it. ``metadata.note`` names the
commits they came from; once the writer emits this schema they are regenerated instead.
